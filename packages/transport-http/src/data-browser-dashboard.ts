...
<body>
  ...
  <main class="shell">
    ...
    <section class="panel detail" id="detail">
      ...
      <div class="coverage-grid" id="coverage"><div class="coverage-card"><div class="coverage-label">覆盖状态</div><div class="coverage-value">—</div></div></div><div class="chart-wrap" id="bar-chart"><canvas id="bar-chart-canvas" aria-label="行情柱图与成交量图" role="img"></canvas><div class="chart-empty" id="bar-chart-empty">请选择一个标的</div><div class="chart-tooltip" id="bar-chart-tooltip" hidden></div></div><div class="table-wrap" id="bars" hidden><div class="empty">请选择一个标的</div></div><div class="pager bar-pager"><span id="bar-summary">—</span><div class="pager-actions"><button id="bar-previous" disabled>上一页</button><button id="bar-next" disabled>下一页</button></div></div><div class="quality" id="quality"><div class="quality-title">每日分钟完整性</div><div class="quality-note">选择 1 分钟周期后显示。</div></div>
    </section>
