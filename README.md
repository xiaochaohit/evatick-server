...
当前版本覆盖中国内地 A 股、上交所/深交所/中证指数、六家中国期货交易所、国际黄金白银与原油日线参考/连续序列，以及按交易所隔离的 Binance 和 Coinbase 加密货币。同花顺扶摇提供官方 A 股与指数目录、快照和日线；可选的银河证券星耀数智 AmazingData 提供 A 股与指数目录、快照、分钟/日线、复权因子和历史指数成分；AKShare 可选地补充免费行情、未覆盖期货能力和新浪财经外盘商品日线。任何单一数据提供方都不是服务的产品边界。
...
- 使用 AKShare 的新浪财经外盘接口读取 `XAU`、`XAG`、`GC`、`SI`、`CL` 和 Brent 历史日线；这些是免费参考/连续序列，不是交易所官方月份合约行情
